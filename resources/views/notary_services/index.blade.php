                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1 flex-wrap">
                                <a href="{{ route('notary-services.show', $s->id) }}" class="btn btn-sm btn-info me-1"
                                    title="Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('notary-services.edit', $s->id) }}" class="btn btn-sm btn-warning me-1"
                                    title="Edit">
                                    <i class="fas fa-pen"></i>
                                </a>
                                <form action="{{ route('notary-services.destroy', $s->id) }}" method="POST"
