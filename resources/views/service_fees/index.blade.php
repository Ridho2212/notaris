                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-1 flex-wrap">
                            ...
                            {{-- Download --}}
                            <a href="{{ route('service-fees.print', $f->id) }}" class="btn btn-sm btn-secondary" target="_blank" title="Download">
                                <i class="fas fa-download"></i>
                            </a>

                            {{-- Hapus --}}
                            <form action="{{ route('service-fees.destroy', $f->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus?');">
                                @csrf
                                @method('DELETE')
